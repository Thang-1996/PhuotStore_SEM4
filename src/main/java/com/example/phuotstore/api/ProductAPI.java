...
import com.example.phuotstore.dto.ProductDTO;
...
public class ProductAPI {
    ...
    public ResponseEntity<?> createProduct(@Valid @RequestBody ProductDTO productDTO) {
        ...
        Optional<Category> optionalCategory = categoryRepository.findCategoryByID(productDTO.getCategoryID());
        if (!optionalCategory.isPresent()) {
            return ResponseEntity.unprocessableEntity().build();
        }


        Product product = new Product(productDTO.getProductName(), productDTO.getProductCode(), productDTO.getProductDesc(), productDTO.getImages(), productDTO.getDiscount(), productDTO.getStatus(), productDTO.getQty(), productDTO.getPrice(), productDTO.getRental(), productDTO.getRating());
