  ...
  <div>
    <a-spin :spinning="loading">
      <a-modal
        ...
        @cancel="close"
      >
        <a-form-model :model="category" :label-col="labelCol" :wrapper-col="wrapperCol"
        >
          <a-form-model-item label="Category Name">
            <a-input v-model="category.categoryName" placeholder="Enter Category Name" />
          </a-form-model-item>
          <a-form-model-item label="Category Code">
            <a-input v-model="category.categoryCode" placeholder="Enter Category Code" />
          </a-form-model-item>
          <a-form-model-item label="Category Desc">
            <a-input v-model="category.categoryDesc" placeholder="Enter Category Desc" />
          </a-form-model-item>
